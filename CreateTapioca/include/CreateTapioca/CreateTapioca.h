...
#ifndef CREATETAPIOCA_H
#define CREATETAPIOCA_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  CreateTapioca(RTC::Manager* manager);
 ...
 protected:
   ...
   * - Type: TimedLong
   */
  InPort<RTC::TimedLong> m_addTapiIn;
...
extern "C"
{
  DLL_EXPORT void CreateTapiocaInit(RTC::Manager* manager);
};

#endif // CREATETAPIOCA_H
